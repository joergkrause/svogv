...
import { InputConverter, EnumConverter } from './models/inputconverter';
import { InfoBoxOptions } from './models/infoboxoptions.model';
import { Meaning } from './models/enum-colors';
