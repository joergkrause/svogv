...
> This is work in progress. Come back often to get recent updates. Currently it's version 0.3.5, published Sep 15, 2017. The current version embraces Angular 4.4. It's working with Angular 2.2 onwards.
